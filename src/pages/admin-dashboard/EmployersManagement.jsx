        ...
        <div className="ml-16 md:ml-64 flex-1 min-h-screen">
          ...
          <div className="p-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              {[
                { label: "Total Employers", value: "1,247", color: "#28BBBB", icon: <FaBuilding /> },
                { label: "Verified Employers", value: "1,247", color: "#00CA9B", icon: <FaCheckCircle /> },
                { label: "Pending Verification", value: "1,247", color: "#FF6221", icon: <FaClock /> },
                { label: "Total Open Positions", value: "1,247", color: "#B627A1", icon: <FaBriefcase /> },
              ].map((card, idx) => (
                <div
                  key={idx}
                  className="bg-white p-4 rounded-xl shadow flex flex-col gap-3"
                >
                  <div className="w-10 h-10 flex items-center justify-center rounded-lg text-white"
