        ...
        <div className="flex flex-col lg:flex-row items-center min-h-screen py-12 lg:py-0 pt-[72px]">
          ...
          <div className="flex-1 text-center lg:text-left mb-12 lg:mb-0 lg:pr-12">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <button className="px-6 py-3 bg-[var(--color-primary-100)] text-white font-medium rounded-md hover:bg-teal-600 transition-colors">
                Hire Talent →
              </button>
              <button className="px-6 py-3 border-2 border-black text-black font-medium rounded-md hover:bg-gray-50 transition-colors">
                View Talents
              </button>
            </div>
          </div>
