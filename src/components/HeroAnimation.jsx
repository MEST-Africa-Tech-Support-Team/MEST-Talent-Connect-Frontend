...
// export default function HeroAnimation() {
//     return (
//         <div className="min-h-screen bg-animated-primary relative overflow-hidden">
//             {/* Animated Background Elements */}
//             <div className="absolute inset-0 pointer-events-none">
//                 {/* Floating Symbols */}
//                 <div className="absolute top-20 left-10 text-[#28BBBB] text-2xl opacity-30 animate-float-slow animate-drift animate-wobble">{"{ }"}</div>
//                 <div className="absolute top-40 right-20 text-[#28BBBB] text-3xl opacity-40 animate-float-medium animate-wobble animation-delay-2000">{"< />"}</div>
//                 <div className="absolute bottom-32 left-20 text-[#28BBBB] text-2xl opacity-35 animate-float-fast animate-drift animation-delay-3000">{"[ ]"}</div>
//                 <div className="absolute top-60 left-1/3 text-[#28BBBB] text-xl opacity-30 animate-float-slow animate-drift animation-delay-1000">{"( )"}</div>
//
//                 {/* Floating Keywords */}
//                 <div className="absolute top-32 right-1/3 text-[#28BBBB] text-lg opacity-25 animate-pulse-glow">React</div>
//                 <div className="absolute bottom-40 left-1/4 text-[#28BBBB] text-lg opacity-30 animate-pulse-glow animation-delay-2000">Node.js</div>
//                 <div className="absolute top-1/2 right-10 text-[#28BBBB] text-lg opacity-25 animate-pulse-glow animation-delay-1000">MongoDB</div>
//                 <div className="absolute bottom-60 right-1/2 text-[#28BBBB] text-lg opacity-30 animate-pulse-glow animation-delay-3000">Express</div>
//
//                 {/* Floating Dots */}
//                 <div className="absolute top-24 left-1/2 w-3 h-3 bg-[#28BBBB] opacity-40 rounded-full animate-bounce-slow animate-drift"></div>
//                 <div className="absolute bottom-24 left-1/3 w-2 h-2 bg-[#28BBBB] opacity-50 rounded-full animate-bounce-medium animate-wobble"></div>
//                 <div className="absolute top-1/3 right-1/4 w-4 h-4 bg-[#28BBBB] opacity-30 rounded-full animate-bounce-fast animate-drift"></div>
//
//                 {/* Subtle Grid */}
//                 <div className="absolute inset-0 opacity-5">
//                     <div className="grid grid-cols-12 grid-rows-8 h-full w-full">
//                         {Array.from({ length: 96 }).map((_, i) => (
//                             <div key={i} className="border border-[#28BBBB]/20 animate-pulse-very-slow"></div>
//                         ))}
//                     </div>
//                 </div>
//             </div>
...
//                     <span className="text-white">Web Developers</span>
//                     <br />
//                     <span className="text-[#28BBBB] text-3xl md:text-4xl lg:text-5xl">from Ghana</span>
//                 </h1>
//
//                 <p className="text-slate-200 text-lg md:text-xl mb-8 max-w-3xl text-pretty">
//                     Discover skilled, motivated developers trained to build and deliver real-world digital solutions. Our
//                     graduates are equipped with MERN stack expertise and strong workplace competencies.
//                 </p>
//
//                 <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
//                     <button className="px-6 py-3 bg-[#28BBBB] text-white font-medium rounded-md hover:bg-[#28BBBB]/90 transition-colors hover:scale-105 transform duration-300">
//                         Hire Talent →
//                     </button>
//                     <button className="px-6 py-3 border-2 border-white text-white font-medium rounded-md hover:bg-white hover:text-slate-900 transition-colors hover:scale-105 transform duration-300">
//                         View Talents
//                     </button>
//                 </div>
//             </div>
